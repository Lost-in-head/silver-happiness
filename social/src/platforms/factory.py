"""Build platform adapters from config and env."""
...
def get_reddit_adapter(
    config: dict[str, Any] | None = None, headless: bool = True
) -> RedditAdapter:
    """Build RedditAdapter from config + env. Env vars take priority over config file."""
    config = config or {}
